    ...
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-background to-muted p-4">
      <Card className="w-full max-w-md">
        ...
        <CardContent>
          ...
          <div className="space-y-2">
            <Button variant="outline" className="w-full" onClick={() => window.open('https://oauth.telegram.org/auth?bot_id=8418868047&origin=' + encodeURIComponent(window.location.origin), '_blank')}>
            ...
            <Button variant="outline" className="w-full" onClick={() => window.open('https://id.vk.com/auth?app_id=0&redirect_uri=' + encodeURIComponent(window.location.origin + '/auth/vk'), '_blank')}>
