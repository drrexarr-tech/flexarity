    ...
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-background to-muted p-4">
      <Card className="w-full max-w-md">
        ...
        <CardContent>
          ...
          <div className="space-y-2">
            <Button variant="outline" className="w-full" onClick={() => window.open('https://oauth.telegram.org/auth?bot_id=0&origin=' + encodeURIComponent(window.location.origin), '_blank')}>
